...
<body>
	<div class="container">
		...
		<div class="panel panel-info">
			 ...
			 -->
				...
				<input type = "hidden" name = "idx" value="<%=vo.getIdx()%>">
					<table class = "table table-bordered table-hover">
						...
						<tr>
							<td>작성자</td>					
							<td><input value="<%=vo.getWriter()%>" name = "writer" type ="type" class = "form-cotrol" placeholder="작성자를 입력하세요"></td>					
						</tr>
						<tr>
			...
			<div class="panel-footer">LG DX - 김찬휘</div>
		</div>
	</div>
</body>
</html>